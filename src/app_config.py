...
class AppConfig(object):
    def __init__(self):
        ...
        self.block_explorer_tx_mainnet = 'http://144.91.66.140/tx/%TXID%'
        self.block_explorer_addr_mainnet = 'http://144.91.66.140/address/%ADDRESS%'
        self.block_explorer_tx_testnet = 'https://testexplorer.zcore.cash/tx/%TXID%'
        self.block_explorer_addr_testnet = 'https://testexplorer.zcore.cash/address/%ADDRESS%'
